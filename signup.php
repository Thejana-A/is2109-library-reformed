...
<body>
    <center>
        <div class="login-box">
            <form method="post" name="signupForm" action="php/signup.php" enctype="multipart/form-data" onSubmit="return validateForm()">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><input type="file" name="membershipID" accept="image/png, image/gif, image/jpeg, image/tiff" required /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                    </tr>
